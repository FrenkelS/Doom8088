...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DWAD_FILE=\"DOOM136.WAD\" -DNR_OF_COLORS=136"
...
ia16-elf-gcc -c i_vtgah.c  $RENDER_OPTIONS -march=$CPU -mcmodel=medium -Ofast -fomit-frame-pointer -fgcse-sm -fgcse-las -fipa-pta -mregparmcall -flto -fwhole-program -funroll-loops
