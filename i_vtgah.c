...
static const uint8_t VGA_TO_ETGA_LUT_ODD[256] =
{
...
static const uint8_t VGA_TO_ETGA_LUT_EVEN[256] =
{
	  0,  96,   0, 112, 255, 128, 128,   0,   0, 136, 128, 128,   0, 134, 134, 134,
	255, 255, 247, 252, 252, 252, 252, 252, 252, 199, 199, 199, 199, 199, 204, 204,
	204, 204, 198, 196, 196, 196, 192, 192,  68,  68,  68,  68,  68,  68,  64,  64,
	255, 255, 255, 255, 255, 255, 254, 254, 254, 254, 254, 231, 231, 231, 236, 236,
	236, 236, 236, 236, 228, 228, 194, 194, 194, 194, 194, 134, 134, 134,  96,  96,
	255, 255, 255, 255, 255, 255, 255, 255, 255, 247, 247, 247, 247, 247, 247, 247,
	248, 248, 240, 119, 119, 119, 135, 135, 135, 112, 112, 112, 136, 136, 136, 128,
	250, 227, 167, 167, 167, 167, 170, 168, 168, 168, 160, 130, 130,  32,  32,   0,
	247, 247, 252, 246, 246, 246, 229, 229, 229, 195, 195, 118, 118, 116, 134, 134,
	229, 229, 229, 118, 194, 194, 134, 134, 225, 225, 225, 114,  99,  99, 136, 136,
	254, 238, 238, 236, 230, 228, 102, 102, 255, 255, 255, 247, 252, 199, 204, 196,
	 68,  68,  68,  68,  68,  68,  68,  68,  68,  68,  68,  68,  68,  68,  68,  64,
	255, 255, 255, 249, 249, 151, 153, 145,  17,  17,  17,  17,  17,  17,  17,  17,
	255, 255, 255, 254, 254, 231, 236, 230, 228, 228, 228, 228, 228, 198, 198, 198,
	255, 255, 255, 254, 254, 238, 238, 238, 198, 198, 102, 100, 134, 134,  96,  96,
	 17,  16,  16,  16,  16,   0,   0,   0, 238, 238, 253, 213, 213, 213,  85, 244
};
...
static void I_DrawBuffer(uint8_t __far* buffer)
{
	...
	for (uint_fast8_t y = 0; y < SCREENHEIGHT / 2; y++) {
		...
		for (uint_fast8_t x = 0; x < SCREENWIDTH; x++) {
			*dst++ = VGA_TO_ETGA_LUT_ODD[*src++];
		}
		dst += SCREENWIDTH_VGA - SCREENWIDTH;

		for (uint_fast8_t x = 0; x < SCREENWIDTH; x++) {
			*dst++ = VGA_TO_ETGA_LUT_EVEN[*src++];
		}
		dst += SCREENWIDTH_VGA - SCREENWIDTH;
	}
}
