...
#define FUZZCOLOR1 0x0000
#define FUZZCOLOR2 0x0808
#define FUZZCOLOR3 0x8080
#define FUZZCOLOR4 0x8888
#define FUZZTABLE 50

static const int16_t fuzzcolors[FUZZTABLE] =
{
