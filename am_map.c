...
#elif NR_OF_COLORS == 4
static const uint8_t mapcolor_back = 0;
static const uint8_t mapcolor_wall = 3;
static const uint8_t mapcolor_fchg = 3;
static const uint8_t mapcolor_cchg = 3;
static const uint8_t mapcolor_clsd = 3;
static const uint8_t mapcolor_rdor = 3;
static const uint8_t mapcolor_bdor = 3;
static const uint8_t mapcolor_ydor = 3;
static const uint8_t mapcolor_tele = 3;
static const uint8_t mapcolor_secr = 3;
static const uint8_t mapcolor_unsn = 3;
static const uint8_t mapcolor_sngl = 3;
