...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DFLAT_SKY_COLOR=7 -DWAD_FILE=\"DOOM16D.WAD\" -DVIEWWINDOWWIDTH=$1 -DMAPWIDTH=$((8*$1)) -DNR_OF_COLORS=16"
...
ia16-elf-gcc -c i_vega.c   $RENDER_OPTIONS -march=$CPU -mcmodel=medium -mnewlib-nano-stdio -Ofast -fomit-frame-pointer -fgcse-sm -fgcse-las -fipa-pta -mregparmcall -flto -fwhole-program -funroll-all-loops -fira-loop-pressure -freorder-blocks-algorithm=simple -fno-tree-pre
