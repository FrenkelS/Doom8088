...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DWAD_FILE=\"DOOM16DT.WAD\" -DVIEWWINDOWWIDTH=80 -DVIEWWINDOWHEIGHT=25 -DMAPWIDTH=80 -DNR_OF_COLORS=2 -DENDOOM_SEGMENT=0xb000"
