...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=205 -DFLAT_SKY_COLOR=177 -DWAD_FILE=\"DOOM2T.WAD\" -DVIEWWINDOWWIDTH=80 -DVIEWWINDOWHEIGHT=25 -DMAPWIDTH=80 -DNR_OF_COLORS=2"
