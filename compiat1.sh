...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DWAD_FILE=\"DOOM16.WAD\" -DVIEWWINDOWWIDTH=40 -DVIEWWINDOWHEIGHT=25 -DMAPWIDTH=40 -DNR_OF_COLORS=16"

#export CPU=i8088
export CPU=i286

nasm i_vtexta.asm -f elf -DPLANEWIDTH=80
