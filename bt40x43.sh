...
export RENDER_OPTIONS="-DFLAT_SPAN -DFLAT_NUKAGE1_COLOR=32 -DWAD_FILE=\"DOOM136.WAD\" -DVIEWWINDOWWIDTH=40 -DVIEWWINDOWHEIGHT=43 -DMAPWIDTH=40 -DNR_OF_COLORS=136"

#export CPU=i8088
export CPU=i286

nasm i_vtexta.asm -f elf -DPLANEWIDTH=80 -DVIEWWINDOWHEIGHT=43
